      ...
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        switch (widget.trimMode) {
          case TrimMode.length:
            if (widget.trimLength < widget.stringData.length) {
              textSpan = TextSpan(
                style: effectiveTextStyle,
                text: _readMore
                    ? widget.stringData.substring(0, widget.trimLength)
                    : widget.stringData,
          ...
          case TrimMode.line:
            if (textPainter.didExceedMaxLines) {
              textSpan = TextSpan(
                style: effectiveTextStyle,
                text: _readMore
                    ? widget.stringData.substring(0, endIndex) +
